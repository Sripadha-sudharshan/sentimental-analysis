"""soaring_energy_prices URL Configuration
...
from soaring_energy_prices import settings
...
urlpatterns = [
    ...
    url(r'^Predict_Soaring_Energy_Price_Sentiment_Type/$', remoteuser.Predict_Soaring_Energy_Price_Sentiment_Type, name="Predict_Soaring_Energy_Price_Sentiment_Type"),
    ...
    url(r'^View_Soaring_Energy_Price_Sentiment_Type_Ratio/$', serviceprovider.View_Soaring_Energy_Price_Sentiment_Type_Ratio, name="View_Soaring_Energy_Price_Sentiment_Type_Ratio"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^View_Soaring_Energy_Price_Sentiment_Type/$', serviceprovider.View_Soaring_Energy_Price_Sentiment_Type, name="View_Soaring_Energy_Price_Sentiment_Type"),
